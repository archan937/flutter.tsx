...
import type { FlutterElement, ShortcutActivator } from 'flutter-tsx';
import {
  AboutDialog,
  AboutListTile,
  AbsorbPointer,
...
export const CallbackShortcutsExample = () => (
  <CallbackShortcuts
    bindings={
      new Map<ShortcutActivator, () => void>([
        [new CharacterActivator('example'), () => {}],
      ])
    }
  >
    <Text>Content</Text>
...
export const CupertinoSegmentedControlExample = () => (
  <CupertinoSegmentedControl
    children={
      new Map<unknown, FlutterElement>([['example', <Text>Content</Text>]])
    }
    onValueChanged={() => {}}
  />
);
